...
package com.app.iostudio.youtube;
...
import com.app.iostudio.youtube.common.BlackBoardDialogFragment;
...
/**
 * This {@link DialogFragment} is used to play a YouTube video in fullscreen. Once shown for the
 * first time, it will add a {@link CustomYouTubePlayerFragment} into it and start playing the Video
 * on demand.
 * <p>
...
public final class YouTubePlayerDialog extends BlackBoardDialogFragment {
    ...
    static final String ARGS_INIT_DATA = "iostudio:youtube:init_data";
    ...
    final FragmentLifecycleCallbacks callbacks = new FragmentLifecycleCallbacks() {
        ...
        public void onFragmentStarted(FragmentManager fm, Fragment f) {
            if (f == fragment && (f instanceof CustomYouTubePlayerFragment)) {
                maybeInitPlayer((CustomYouTubePlayerFragment) f);
            }
        }
    ...
    InitData getDataFromArgs() {
        ...
        return args != null ? (InitData) args.getParcelable(ARGS_INIT_DATA) : null;
    }
    ...
    InitData getLatestData() {
        ...
        return new InitData(initData.adapterOrder, initData.videoId, info,
                initData.returnOrientation);
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_dialog_yt_player, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle bundle) {
        ...
        initializedListener = new YouTubePlayer.OnInitializedListener() {
            ...
            public void onInitializationSuccess(YouTubePlayer.Provider provider,
                ...
                if (initData != null) {
                    ...
                    player.loadVideo(initData.videoId,
                            (int) initData.playbackInfo.getResumePosition());
                }
            }
        ...
        if (fragment == null) {
            fragment = CustomYouTubePlayerFragment.newInstance();
            getChildFragmentManager().beginTransaction().replace(R.id.player_dialog, fragment)
                    .commit();
        }
    }
    ...
    final void maybeInitPlayer(@NonNull final CustomYouTubePlayerFragment fragment) {
        ...
        view.getViewTreeObserver().addOnGlobalLayoutListener(new OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                fragment.initialize(getString(R.string.developer_key), initializedListener);
            }
        });
    }
