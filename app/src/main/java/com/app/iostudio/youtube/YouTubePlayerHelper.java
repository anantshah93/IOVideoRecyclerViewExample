...
public final class YouTubePlayerHelper extends ToroPlayerHelper implements Handler.Callback {
    ...
    CustomYouTubePlayerFragment ytFragment;
    ...
    public boolean handleMessage(Message message) {
        switch (message.what) {
            ...
            case MSG_PLAY:
                ...
                ytFragment.initialize(App.getYTApi(),
                        new YouTubePlayer.OnInitializedListener() {
                            ...
                            public void onInitializationSuccess(Provider provider,
                                ...
                                if (helper.callback != null)
                                    helper.callback.onPlayerCreated(helper, player);
                                ...
                                player.setShowFullscreenButton(
                                        false);  // fullscreen requires more work ...
                                if (shouldPlay()) { // make sure YouTubePlayerView is fully visible.
                                    player.loadVideo(videoId,
                                            (int) helper.playbackInfo.getResumePosition());
                                }
                            }
    ...
    class StateChangeListenerImpl implements PlayerStateChangeListener {
        ...
        public void onError(YouTubePlayer.ErrorReason reason) {
            ...
            if (ytFragment != null && ytFragment.isAdded()) {
                Toast.makeText(ytFragment.requireContext(), "Error: " + reason, Toast.LENGTH_SHORT)
                        .show();
            }
        }
    }
    ...
    public interface Callback {
        ...
        void onFullscreen(@NonNull YouTubePlayerHelper helper,
