...
public final class YouTubePlayerManager {
    ...
    public YouTubePlayerManager(@NonNull FragmentManager manager,
    ...
    public YouTubePlayerHelper obtainHelper(@NonNull ToroPlayer player, String videoId) {
        ...
        CustomYouTubePlayerFragment fragment = CustomYouTubePlayerFragment.newInstance();
        fragment.setPlayerHelper(helper);
        manager.beginTransaction().replace(viewId, fragment).commitAllowingStateLoss();
        return helper;
    }

    public void releaseHelper(ToroPlayer player) {
